<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="所属类别。0-信息整合，1-信息提取" prop="clazz">
        <el-input
          v-model="queryParams.clazz"
          placeholder="请输入所属类别。0-信息整合，1-信息提取"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="创建时间" prop="createName">
    ...
    <el-table v-loading="loading" :data="promptList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="类别名" align="center" prop="name" />
      <el-table-column label="提示词内容" align="center" prop="prompt" />
      <el-table-column label="所属类别。0-信息整合，1-信息提取" align="center" prop="clazz" />
      <el-table-column label="创建时间" align="center" prop="createName" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.createName, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="更新时间" align="center" prop="updateName" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.updateName, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="所属类别。0-信息整合，1-信息提取" prop="clazz">
          <el-input v-model="form.clazz" placeholder="请输入所属类别。0-信息整合，1-信息提取" />
        </el-form-item>
        <el-form-item label="创建时间" prop="createName">
          <el-date-picker clearable
  ...
  data() {
    return {
      ...
      rules: {
        ...
        clazz: [
          { required: true, message: "所属类别。0-信息整合，1-信息提取不能为空", trigger: "blur" }
        ],
      }
    };
  },
