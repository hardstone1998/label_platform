    ...
    <el-row :gutter="40" style="margin-bottom: 100px">
      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
        <el-card
          ...
          shadow="never"
        >
          <h3 style="font-weight: bold">审核分配</h3>
          <el-row :gutter="40" class="panel-group">
            <el-col :span="12" class="card-panel-col">
              <div class="card-panel">
                <div class="card-panel-icon-wrapper icon-blue">
                ...
                <div class="card-panel-description">
                  <div class="card-panel-text">审核分配</div>
                </div>
              </div>
            </el-col>
            <!-- 审核情况 -->
            <el-col :span="12" class="card-panel-col">
              <div class="card-panel">
                <div class="card-panel-icon-wrapper icon-blue">
                  ...
                  >
                    <el-button type="info" icon="el-icon-message" circle @click="uploadASR"></el-button>
                  </el-upload>
                </div>
                <div class="card-panel-description">
                  <div class="card-panel-text">审核情况</div>
                  <count-to
                    :start-val="0"
